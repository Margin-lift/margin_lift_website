        ...
        <div className="grid grid-cols-[7fr_5fr] gap-[clamp(32px,6vw,88px)] lg:grid-cols-1 md:gap-[clamp(24px,5vw,56px)] items-start">
          ...
          <div className="flex flex-col justify-between gap-[clamp(20px,4vw,32px)]">
            <div className="space-y-[clamp(20px,4vw,44px)]">
              ...
              <div className="border-l-2 border-terracotta pl-[clamp(16px,4vw,28px)] pt-[clamp(12px,2vw,16px)]">
                <span className="mono block mb-[clamp(8px,2vw,14px)] text-terracotta text-[clamp(9px,2vw,12px)]">Layer 2 — Coordination cost</span>
                <p className="text-[clamp(14px,3vw,17px)] leading-[1.8] text-[#D8D1C3]">
          ...
          <div className="border border-line-dark bg-cream-dim p-[clamp(20px,4vw,56px)] flex flex-col justify-between gap-[clamp(20px,4vw,44px)]">
            ...
            <div>
              ...
              <div className="mt-[clamp(12px,3vw,44px)] pt-[clamp(16px,3vw,32px)] border-t border-line-dark font-mono text-[clamp(9px,2vw,12px)] letter-spacing-[0.16em] uppercase text-terracotta leading-[1.8]">
